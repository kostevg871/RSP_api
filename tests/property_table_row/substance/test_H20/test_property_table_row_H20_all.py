...
list_name_property = ["Specific Gibbs energy",
                      "Specific enthropy", "Joule-Thompson coefficient", "Kinematic viscosity", "Isoenthropic coefficient", "Prandtl number"]


@pytest.mark.parametrize(
    "property, value_Pa, value_T, dimension_Pa, dimension_T, result_value, dimension, nameProperty",
    [
